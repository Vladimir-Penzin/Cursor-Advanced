const mainpage = `
    <header>
        <h1 class="main_title">Star Wars</h1>
        <nav>
            <div class="buttons">
            ...
            <div class="search">
                <input type="text" placeholder="Enter film No" id="myInput">
...
function showCatalogue (data, catalogue) {
    ...
    if (catalogue === "films") {
        data.results.forEach((elem) => {
            ...
            <div class="card card_film">
                <div class="card_image">
                    <img src="./img/${elem.title.toLowerCase().replaceAll(" ", "")}.jpg" alt="${elem.title}">
                </div>
                <div class="card_text">
        ...
        data.results.forEach((elem) => {
            ...
            <div class="card">
                <div class="card_image">
                    <img src="./img/${elem.name.toLowerCase().replaceAll(" ", "")}.webp" alt="${elem.name}">
                </div>
                <div class="card_text">
...
function showCharacter (data) {
    information = information + `
        <div class="card">
            <div class="card_image">
                <img src="./img/${data.name.toLowerCase().replaceAll(" ", "")}.webp" alt="${data.name}">
            </div>
            <div class="card_text">
...
//works only if use at first. If any button (films, persons, planets) has been pressed, it doesn't work...
...
function showFilm (data) {
    information = information + `
        <div class="card">
            <div class="card_image">
                <img src="./img/${data.title.toLowerCase().replaceAll(" ", "")}.jpg" alt="${data.title}">
            </div>
            <div class="card_text">
...
document.querySelector("#submit-btn").addEventListener("click", e => {
    ...
    while (i < 1) {
        if (Boolean(Number(inputVal)) == true && Number(inputVal) >= 1 && Number(inputVal) <= 6) {
            information = ""
            cards.innerHTML = information
